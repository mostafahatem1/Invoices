				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . $page='Archive') }}">أرشيف</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='customers_report') }}">التقارير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائم المستخدمين</a></li>
                            @endcan
